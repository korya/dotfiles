...
ZSH_HIGHLIGHT_STYLES[comment]='fg=242' # Make comments visible again
...
# Ensure venv prompt is always displayed
...
export LESS_TERMCAP_md=$'\e[01;33m'    # begin bold (yellow)
export LESS_TERMCAP_me=$'\e[0m'         # end formatting
export LESS_TERMCAP_se=$'\e[0m'         # end standout mode
export LESS_TERMCAP_so=$'\e[01;46;33m'  # begin standout-mode (yellow text on cyan background)
export LESS_TERMCAP_ue=$'\e[0m'         # end underline
export LESS_TERMCAP_us=$'\e[01;36m'     # begin underline (cyan)
